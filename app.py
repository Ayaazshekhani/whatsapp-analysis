...
import numpy as np
import emoji  # Importing the emoji library
...
if uploaded_file is not None:
    ...
    # Sending the file data to the preprocess function for further processing
    ...
    # Including "Overall" for overall chat group analysis
